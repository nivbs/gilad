...
export function Masthead({ masthead }: MastheadProps) {
  return (
    <header className="border-b-4 border-double border-ink pb-6 text-center">
      ...
      <h1 className="font-display text-5xl font-bold tracking-tight text-ink md:text-8xl">
        {masthead.title}
      </h1>
      <p className="mt-2 font-display text-xl italic text-ink-muted md:text-3xl">
        {masthead.subtitle}
      </p>
